...
/*
 * Classe che rappresenta l'interfaccia grafica relativa alle statistiche per il referendum.
 */
public class StatisticheReferendum extends JFrame{
	...
	//costruttore
	public StatisticheReferendum() throws SQLException {
